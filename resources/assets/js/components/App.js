            ...
            <Router>  
                <div>
                    ...
                    <Switch>
                        ...
                        <PrivateRoute exact path= '/employees/add'         isAuth = {this.state.isAuth} component = {EmployeAdd}/>
                        <PrivateRoute exact path= '/employees/:id/edit/'   isAuth = {this.state.isAuth} component = {EmployeEdit}/>
                        <PublicRoute  exact path= '/login' component = {Login} changeAuth = {this.changeAuth} isAuth = {this.state.isAuth}  />
                    </Switch> 
                </div>
            </Router>       
          </div>);
